    ...
    public static class Converter
    {
        ...
        public static DateTime? ToDateTimeNullable(this string str)
        {
            ...
            try
            {
                ...
                foreach (string item in DateTimeFormatStringList)
                {
                    if (DateTime.TryParseExact(str, item, CultureInfo.InvariantCulture, DateTimeStyles.None, out value))
                    {
                        break;
                    }
                }
        ...
        public static float? ToFloatNullable(this string str)
        {
            ...
            {
                float output;
                if (float.TryParse(str, out output)) return output;
        ...
        public static double? ToDoubleNullable(this string str)
        {
            ...
            {
                double output;
                if (double.TryParse(str, out output)) return output;
